     ...
     <div class="col">
         <form method="post" action="vente">
             ...
             <div class="input-group mb-3">
                 ...
                 <input type="text" class="form-control" placeholder="nom de l'article" name="article" value="${articleToDisplay.article}" required></span>
             </div>
             <%--DESCRIPTION--%>
                 <div class="input-group">
                     <span class="input-group-text" >Description :  <p class="text-danger">* </p>
                     <textarea class="form-control" placeholder="décrire l'article" id="floatingTextarea2" style="height: 100px" name="description" required>${articleToDisplay.description}</textarea></span>
                 </div><br>
             <%--CATEGORIES--%>
             <div>
                 ...
                 <jsp:include page="fragments/categorie.jsp">
                     ...
                     <jsp:param name="selectedCat" value="${articleToDisplay.categorie.id}"/>
                 </jsp:include>
                 </span>
             </div>
             <br>
             ...
             <div>
                 ...
                 <input type="number" id="tentacles" name="prixDepart" min="1" max="" value="${articleToDisplay.prixInitial}" required></span>
             </div><br>
             ...
             <%--DEBUT ENCHERE--%>
                 <div>
                     ...
                     <input type="datetime-local" id="debutEnchere" name="debutEnchere"
                            value="${empty articleToDisplay ? dateDuJour : articleToDisplay.dateDebut}"
             ...
             <%--FIN ENCHERE--%>
                 <div>
                     ...
                     <input type="datetime-local" id="finEnchere" name="finEnchere"
                        value="${empty articleToDisplay ? "" : articleToDisplay.dateFin}"
             ...
             <%--BLOC RETRAIT--%>
                ...
                <%--RUE--%>
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="rue" name="rue" value="${empty articleToDisplay ? loggedUserAdresse.rue : articleToDisplay.adresse.rue}" required>
                    </div>
                <%--CODE POSTAL--%>
                    <div class="input-group mb-3">
                        <span class="input-group-text" >Code Postal : </span>
                        <input type="text" class="form-control" placeholder="code postal" name="cpo" value="${empty articleToDisplay ? loggedUserAdresse.cpo : articleToDisplay.adresse.cpo}" required>
                    </div>
                <%--VILLE--%>
                    <div class="input-group mb-3">
                        <span class="input-group-text" >Ville : </span>
                        <input type="text" class="form-control" placeholder="ville" name="ville" value="${empty articleToDisplay ? loggedUserAdresse.ville : articleToDisplay.adresse.ville}" required>
                    </div>
                 </div>
                 <br>
             <%--BOUTON ENREGISTRER--%>
